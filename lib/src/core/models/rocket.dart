...
//
//     final rocketResponse = rocketResponseFromJson(jsonString);
...
class RocketResponse {
    ...
    factory RocketResponse.fromRawJson(String str) => RocketResponse.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory RocketResponse.fromJson(Map<String, dynamic> json) => RocketResponse(
