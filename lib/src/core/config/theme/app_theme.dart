...
class AppTheme {
  ...
  static final Color _lightSnackBarBackgroundErrorColor = Colors.redAccent;
  ...
  static const Color _darkButtonPrimaryColor = Colors.purpleAccent;
  static const Color _darkAppBarColor = Colors.black;
  static final Color _darkIconColor = Colors.deepPurpleAccent;
  static final Color _darkSnackBarBackgroundErrorColor = Colors.redAccent;
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    canvasColor: _lightPrimaryVariantColor,
  );
